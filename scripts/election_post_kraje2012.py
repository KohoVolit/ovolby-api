...
provinces = []
with open("../data/kz2012_data_dbf/kraje.csv") as infile:
...
election = {
    "id": "cz-kraje-2012",
    "name": "Volby do krajských zastupitelstev 2012",
...
for province in provinces:
    election = {
        "id": "cz-kraje-" + province[0] + "-2012",
        "name": "Volby do krajského zastupitelstva 2012 - " + province[1],
        "organization_id": province[0],
        "start_date": "2004-10-12 15:00",
        "end_date": "2004-10-13 14:00",
        "number_of_posts": int(province[2]),
        "parent_id": "cz-kraje-2012"
    }
    cf.post_if_not_exist("elections", election, {"id": election['id']})
