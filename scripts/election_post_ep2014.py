...
# ELECTION
election = {
    "id": "europarl.europa.eu-2014",
    "name": "Volby do Evropského parlamentu 2014",
    "organization_id": "europarl.europa.eu",
    "start_date": "2014-05-22",
    "end_date": "2014-05-25 23:59"
}
cf.post_if_not_exist("elections", election, {"id": election['id']})

election = {
    "id": "europarl.europa.eu-cz-2014",
    "name": "Volby do Evropského parlamentu 2014 v České republice",
    "organization_id": "europarl.europa.eu-cz",
    "start_date": "2014-05-23 15:00",
    "end_date": "2014-05-24 14:00",
    "number_of_posts": 21,
    "parent_id": "europarl.europa.eu-2014"
}
cf.post_if_not_exist("elections", election, {"id": election['id']})
