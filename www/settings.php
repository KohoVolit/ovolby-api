...
$settings['api_server'] = 'http://api.czechia.tk/ovolby/';
...
// table download
$settings['table_available_charsets'] = ['utf-8','cp1250'];
$settings['table_available_formats'] = ['csv','html'];
$settings['table_available_delimiters'] = [',',';'];
